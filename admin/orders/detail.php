                ...
                <div class="detail-grid">
                    ...
                    <div class="detail-card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="info-row">
                                <label>총 주문금액:</label>
                                <span class="amount"><?= number_format($order['total_amount'] ?? 0) ?>원</span>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <tbody>
                                        <?php foreach ($order_items as $item): ?>
                                            <tr>
                                                ...
                                                <td class="price-cell"><?= number_format($item['product_price'] ?? 0) ?>원</td>
                                                <td class="quantity-cell"><?= number_format($item['quantity'] ?? 0) ?>개</td>
                                                <td class="total-cell"><?= number_format($item['total_price'] ?? 0) ?>원</td>
                                            </tr>
                                        <?php endforeach; ?>
                                    </tbody>
                                    <tfoot>
                                        <tr class="total-row">
                                            ...
                                            <td><strong><?= number_format($order['total_amount'] ?? 0) ?>원</strong></td>
                                        </tr>
                                    </tfoot>
                                </table>
                            </div>
