    ...
    if (empty($name)) {
        ...
        try {
            ...
            $sql = "UPDATE products SET
                    ...
                    status = ?, is_featured = ?, discount_percentage = ?, rating_score = ?, review_count = ?, delivery_info = ?, updated_at = CURRENT_TIMESTAMP
                    WHERE id = ?";
            $stmt = $pdo->prepare($sql);
            $stmt->execute([
                ...
                $discount_percentage, $rating_score, $review_count, $delivery_info, $product_id
            ]);
