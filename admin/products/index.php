...
try {
    ...
    // 샘플 상품 데이터 삽입 (테스트용, 실제 컬럼명 stock_quantity 사용)
    $pdo->exec("INSERT IGNORE INTO products (id, name, description, price, category_id, stock_quantity, image_url, status) VALUES 
